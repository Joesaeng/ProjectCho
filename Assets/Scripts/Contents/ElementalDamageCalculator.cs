...
public static class ElementalDamageCalculator
{
    private static readonly float[,] damageMultiplier = {
        ...
        /* Fi */ { 0.75f, 0.5f,  0.5f,  0.75f, 0.75f, 2.0f,  0.75f, 0.75f },
        /* Wa */ { 0.75f, 2.0f,  0.5f,  0.5f,  0.75f, 0.75f, 0.75f, 0.75f },
        /* Li */ { 0.75f, 0.75f, 2.0f,  0.5f,  0.5f,  0.75f, 0.75f, 0.75f },
        /* Ea */ { 0.75f, 0.75f, 0.75f, 2.0f,  0.5f,  0.5f,  0.75f, 0.75f },
        /* Ai */ { 0.75f, 0.5f,  0.75f, 0.75f, 2.0f,  0.5f,  0.75f, 0.75f },
